									...
									<form method="GET" id="sliderForm" autocomplete="off" enctype="multipart/form-data">
										...
										<div class="pl-lg-1">
											<div class="text-center">
												<button type="submit" class="btn btn-info mt-4" id="simpan" formaction="<?= base_url('Laporan/laporan_pengembalian_pdf') ?>"><span id="mitraText">Export to PDF</span></button>
											</div>
										</div>
									</form>
								</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var pinjaman = $('#pinjaman').DataTable({
			...
			"order": [[0, "asc" ]],
			"ajax":{
				url :  base + 'DataTables/laporanPengembalian',
				type : 'POST',
			},
		});
