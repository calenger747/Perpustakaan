...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <?php } else if ($this->session->userdata('level_user') == '2') { ?>
                <li class="menu active">
                    <a href="<?= base_url(); ?>Dashboard_User" aria-expanded="true" class="dropdown-toggle">
                        <div class="">
                            <div class="icon-section">
                                <i data-feather="home"></i><span class="icon-name"> Dashboard</span>
                            </div>
                ...
                <li class="menu">
                    <a href="<?= base_url(); ?>Dashboard_User/Peminjaman" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <div class="icon-section">
                                <i data-feather="log-out"></i><span class="icon-name"> Peminjaman</span>
                            </div>
                ...
                <li class="menu">
                    <a href="<?= base_url(); ?>Dashboard_User/myProfile" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <div class="icon-section">
                                <i data-feather="user"></i><span class="icon-name"> Profil Saya</span>
                            </div>
                        </div>
                    </a>
                </li>
            <?php } else if ($this->session->userdata('level_user') == '3') { ?>
                <li class="menu active">
                    <a href="<?= base_url(); ?>Dashboard_Kepala" aria-expanded="true" class="dropdown-toggle">
                        <div class="">
                            <div class="icon-section">
                                <i data-feather="home"></i><span class="icon-name"> Dashboard</span>
                            </div>
                ...
                <li class="menu">
                    <a href="<?= base_url(); ?>Dashboard_Kepala/myProfile" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <div class="icon-section">
                                <i data-feather="user"></i><span class="icon-name"> Profil Saya</span>
                            </div>
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="laporan" data-parent="#accordionExample">
                        <li>
                            <a href="<?= base_url(); ?>Dashboard_Kepala/laporanAnggota"> Anggota </a>
                        </li>
                        <li>
                            <a href="<?= base_url(); ?>Dashboard_Kepala/laporanBuku"> Buku </a>
                        </li>                           
                        <li>
                            <a href="<?= base_url(); ?>Dashboard_Kepala/laporanPeminjaman"> Peminjaman </a>
                        </li>
                        <li>
                            <a href="<?= base_url(); ?>Dashboard_Admin/laporanPengembalian"> Pengembalian </a>
                        </li>
